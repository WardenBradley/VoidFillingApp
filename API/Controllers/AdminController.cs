...
namespace API.Controllers
{
    public class AdminController : BaseApiController
    {
        ...
        {
            if (string.IsNullOrEmpty(roles)) return BadRequest("Gotta select at least one role");
            ...
            if (!result.Succeeded) return BadRequest("Failed to role user");
        ...
        public async Task<ActionResult> ApprovePhoto(int photoId)
        {
            ...
            if (photo == null) return NotFound("Couldn't Find photo");
